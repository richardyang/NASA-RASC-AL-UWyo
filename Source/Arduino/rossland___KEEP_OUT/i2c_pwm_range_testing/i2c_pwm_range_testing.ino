...
// have!
#define SERVO_MIN  125      // this is the 'minimum' pulse length count (out of 4096@50Hz)
#define SERVO_MAX  505      // this is the 'maximum' pulse length count (out of 4096@50Hz)
